            ...
            <div className="Intro-carousel">
                ...
                >
                    {carouselMovies.map(movie => (
                        <div key={movie._id} className="Intro-slide">
                            <Imagen movie={movie} />
                            <Infocarousel movie={movie} />
                        </div>
                    ))}
