    ...
    return (
        ...
        <>
            <div className="Register-page">
                ...
                <img src="/BlackPrimeLogo.png" alt="prime logo" className="Register-logo" />

                <div className="Register-block">

                    <h1 className="Register-h1"> Crear cuenta</h1>

                    <form className='Register-form' onSubmit={registerNewUser}>
                        <label htmlFor='fullname'> Nombre
                            <input
                                type="text"
                                name='fullname'
                                id='fullname'
                        ...
                        {numberInput ? (
                            <label id='number'> Número de móvil
                        ...
                        <div className="Register-email-link">
                            <div className="Register-span-email" onClick={changeInput}> Utiliza tu dirección de correo electrónico</div>
                            <img src="/LeftArrow.png" alt="arrow" className='Register-email-icon' />
                        </div>
                        ...
                        <input type="password"
                            ...
                            required
                        />
                        <div className="Register-password-span">
                            <img src="/InfoIcon.png" alt="info icon" className='Register-info-icon' />
                            <p className="Register-password-info"> La contraseña debe tener 6 caracteres como mínimo.</p>
                        </div>

                        <p className="Register-p">
                            Para verificar tu número, te enviaremos un mensaje de texto con un código temporal.
