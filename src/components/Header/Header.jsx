...
export const Header = ({toggleSearchBar}) => {
  ...
  useEffect(() => {
    if (location.pathname !== '/home') setHomeClicked(false)
  }, [location.pathname])
...
return(
   ...
   <img src="/WhitePrimeLogo.png" alt="Prime video logo" className="Header-logo" />
    ...
    <div className="Header-ul">
        <div className="Header-li">
         <NavLink
           ...
           className={({ isActive }) => `Header-a Header-a--home${isActive || homeClicked ? ' Header-a--home-active' : ''}`}
         >
           inicio
         </NavLink>
        </div>
        <div className="Header-li">
          <a href="" className="Header-a" onClick={() => setHomeClicked(false)}> peliculas </a>  
        </div>
        <div className="Header-li">
          <a href="" className="Header-a" onClick={() => setHomeClicked(false)}> series </a>  
        </div>
        <div className="Header-li">
          <a href="" className="Header-a" onClick={() => setHomeClicked(false)}> deportes </a>  
        </div>
        <div className="Header-li">
          <a href="" className="Header-a" onClick={() => setHomeClicked(false)}> TV en directo </a>  
        </div>
...
const Headericons = ({toggleSearchBar}) => {
  ...
  <div className="Header-icons">
   ...
   <NavLink to="/add/movie"> <svg className="Header-icon" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="-5 -5 34 34" id="add" y="0"><path d="M3 12h18m-9 9V3" stroke="#FFF" stroke-width="2" fill="none" stroke-linecap="round"/></svg> </NavLink>
    <NavLink to="/login/email"> <img src="/LoginIcon.svg" alt="login" className='Header-login-icon' /></NavLink>
    <NavLink to="/register" className="Header-a-subscription"> Suscribirse a Prime </NavLink>
   </div>
