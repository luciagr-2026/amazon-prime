        ...
        <>
            <div className="Search-bar-container">
                ...
                <form className="Search-bar-wrapper">
                    ...
                    <input value={query} onChange={(e) => setQuery(e.target.value)} type="search" id='Search-bar' placeholder='Buscar' />
                    <button onClick={cleanBar} type='reset' className='Search-reset-button'> Borrar </button>

                </form>

               {query.trim()  && <SearchResultsList filteredMovies={filteredMovies} />}
